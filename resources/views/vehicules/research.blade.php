...
<body>
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <a href="{{route('login')}}" class="btn btn-primary py-md-3 px-md-5 mt-2"> Login to Reserve Now</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <h1 class="display-4 text-uppercase text-center mb-5">Cars with specified criteria</h1>
            <div class="row">
               
                
            <?php
    if ($vehicules->count() == 0) {
        echo "<h1 style='font-size: 40px;'>Pas de tels enregistrements</h1>";
        echo "<br><br><br><br>"; // Two line breaks
        
        echo "<h3 style='text-align: left;'><a href='".route('Allvehicules')."'>Retourner a la liste</a></h3>";
    }
                ...
                <div class="rent-item mb-4" style="height: 650px; width: 350px;">
                    ...
                    <h4 class="text-uppercase mb-4">{{ $v->marque . ' ' . $v->modele }}</h4>
                        ...
                        <br>
                        <br>
                        <a class="btn btn-primary px-4 py-2" href="{{route('register')}}">Reservez Maintenant</a>
